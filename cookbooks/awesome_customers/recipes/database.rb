...
#load the encypted data bag item that holds the database user password
...
cookbook_file node['awesome_customers']['database']['send_file'] do
...
# send the database with a table and test data.
